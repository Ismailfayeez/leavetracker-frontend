...
function LeaveDurationDetail(props) {
  ...
  const { isProjectOwner, isProjectAdmin, isProjectAdminHasPermission } =
    useProjectMemberPermission(LEAVE_DURATION_DLT, LEAVE_DURATION_EDIT);
  ...
  const pages = [
    {
      ...
      component: (
        <ProjectSectionView
          fields={viewFields}
          hasPermissionEdit={
            isProjectOwner || isProjectAdminHasPermission[LEAVE_DURATION_EDIT]
          }
          hasPermissionDelete={
            isProjectOwner || isProjectAdminHasPermission[LEAVE_DURATION_DLT]
          }
        />
      ),
    },
    {
      name: "edit",
      component: (
        <ProjectSectionEdit fields={editFields} schema={leaveDurationSchema} />
      ),
    },
  ];
  return (
