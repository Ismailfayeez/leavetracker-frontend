...
function LeaveTrackerMain({ isPageLoading }) {
  ...
  const { LEAVETRACKER_APP_PERMISSION_GRANT_ALL } = LEAVETRACKER_APP_PERMISSIONS;
  ...
  const fetchEmployeeAdditionalData = useCallback(async () => {
  ...
  }, [currentEmployeeData.id, dispatch]);
