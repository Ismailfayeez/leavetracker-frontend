...
const getApprovalTableColumns = ({ handleInfoModal, handleApproverStatusModal, prevItemIndex }) => {
  return [
    {
      path: 'serial_no',
      label: 'no',
    ...
    },
    {
      ...
      content: (leave) => (
        <div>
          <div onClick={() => handleInfoModal(leave)} className="bold" role="presentation">
