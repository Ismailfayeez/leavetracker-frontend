  ...
  return (
    <div
      className={`group-member card ${
        className ? className : "groupmember--white"
      }`}
    >
      <div className="card__body flex flex--center">
        <div className="flex-grow overflow-auto">
          <div className="group-member__name text-overflow-ellipsis">
            {name}
          </div>
          <div className="groupMember__email text-overflow-ellipsis sub-text">
            {email}
          </div>
        </div>
